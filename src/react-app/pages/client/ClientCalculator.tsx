...
import { Building2, LogOut, Calculator, Plus, Edit, Trash2, Save, X, Play, ArrowLeft, CreditCard, FileText, TrendingUp } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Minhas Fórmulas de Cálculo</h2>
            <p className="text-slate-600">Crie e edite suas fórmulas personalizadas para cálculo de orçamentos</p>
          </div>
