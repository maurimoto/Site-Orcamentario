...
import { Building2, LogOut, FileText, Eye, Download, Filter, ArrowLeft, CreditCard, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="container mx-auto px-4 py-4 max-w-full">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
              <div 
                className="text-right relative cursor-pointer plan-popup-container hidden sm:block"
                onClick={() => setShowPlanPopup(!showPlanPopup)}
              >
                <p className="text-sm font-medium text-slate-900 hover:text-blue-600 transition truncate max-w-[150px]">{user.name}</p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Meus Orçamentos</h2>
          <p className="text-slate-600">Visualize e gerencie seus orçamentos</p>
        </div>
        ...
        <Card className="p-6 mb-6">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex-1 w-full">
              <Input
                type="text"
                placeholder="Buscar por tipo ou localização..."
                value={searchTerm}
        ...
        <Card className="p-6">
          ...
          {filteredQuotes.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 mb-4">Nenhum orçamento encontrado</p>
              <Button onClick={() => navigate("/new-quote")} className="bg-blue-600 hover:bg-blue-700">
